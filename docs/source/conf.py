#
# Sphinx configuration for aiida-wannierjl
#
...
release = aiida_wannierjl.__version__
...
html_title = f"aiida-wannierjl v{release}"
html_theme_options = {}
...
html_use_opensearch = "https://aiida-wannierjl.readthedocs.io"
...
def run_apidoc(_):
    ...
    package_dir = os.path.join(source_dir, os.pardir, os.pardir, "src", "aiida_wannierjl")
